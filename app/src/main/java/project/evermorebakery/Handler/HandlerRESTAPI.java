...
public class HandlerRESTAPI {
    ...
    public void fetchData(String select, VolleyResponseListener listener) {
        String url = "https://android-nam3.000webhostapp.com/select.php";
        select(url, select, listener);
    }

    private void select(String url, String select,  VolleyResponseListener listener) {
    ...
    public void updateData(String select, VolleyResponseListener listener) {
        String url = "https://android-nam3.000webhostapp.com/update.php";
        update(url, select, listener);
    }

    private void update(String url, String select, VolleyResponseListener listener) {
        Uri.Builder builder = Uri.parse(url).buildUpon();
